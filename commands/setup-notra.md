---
name: setup-notra
description: Connect Notra MCP, GitHub, and brand voice, then generate a test changelog draft.
---
...
- MCP **notra** server connected. If auth fails, tell the user to set `NOTRA_API_KEY` from Developer → API Keys and reload.
