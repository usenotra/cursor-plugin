...
description: Generate Notra LinkedIn and Twitter draft posts from recent shipped work. Use when the user runs /generate-social or asks for social copy from GitHub activity.
---
