---
name: manage-skills
description: List, create, or update reusable writing skills in the Notra workspace (for example humanizer). Use when the user runs /manage-skills or wants to save a Notra writing skill.
---

# /manage-skills

These are Notra org writing skills, not Cursor plugin skills.
