---
name: generate-blog
description: Generate a Notra blog post draft about a shipped feature or release. Use when the user runs /generate-blog or asks for a launch article from GitHub activity.
---
...
- Copy markdown to the company blog when ready
